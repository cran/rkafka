...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\includegraphics[width=10mm]{MuSigmaLogo.jpg}}
\fancyfoot[L]{\today}
\fancyfoot[R]{Mu Sigma Inc.}
...
\includegraphics[width=50mm]{MuSigmaLogoText.jpg}\\[1cm]
...
\textsc{\large{\textbf{Version 1.0.0}}} \\[0.3cm]
